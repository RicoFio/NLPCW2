...
if __name__ == "__main__":
    ...
    tr0 = all_valid_parses(lx, ['Which','horse','likes','a','duck','and','jumps','?'])[0]
    tr = restore_words(tr0,['Which','horse','likes','a','duck','and','jumps','?'])
    tr.draw()

    tr0 = all_valid_parses(lx, ['Which','horse','do','Mary','ride','?'])
    print tr0

    # This is a test to show ambiguity
    tr0 = all_valid_parses(lx, ['Who','jumps','and','fucks','ducks','and','likes','ducks','and','jumps','?'])[0]
    tr = restore_words(tr0,['Who','jumps','and','fucks','ducks','and','likes','ducks','and','jumps','?'])
